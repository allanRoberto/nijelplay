...
function et_divi_load_scripts_styles(){
	...
	wp_enqueue_script( 'boostrap-script', $template_dir . '/js/bootstrap.min.js', array( 'jquery' ), $theme_version, true );
    ...
    wp_enqueue_style( 'boostrap-style', $template_dir . '/css/bootstrap.min.css', array(), $theme_version );
...
add_filter( 'rwmb_meta_boxes', 'artezzo_register_meta_boxes' );

function artezzo_register_meta_boxes( $meta_boxes )
{
	...
	$meta_boxes[] = array(
		...
		'title'      => __( 'Galeria de imagens', 'your-prefix' ),
		...
		'fields' => array(
            array(
				'name'             => __( 'Selecione as imagens do produto:', 'your-prefix' ),
				'id'               => "gallery",
				'type'             => 'image_advanced',
			),
        )
