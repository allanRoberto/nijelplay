...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/nijelplay.git"
# set :scm, :subversion
...
set :local_path, "/Users/Allan/Sites/nijelplay" 
...
set :local_domain, 'nijelplay.artezzo.com.br' #FIXME
